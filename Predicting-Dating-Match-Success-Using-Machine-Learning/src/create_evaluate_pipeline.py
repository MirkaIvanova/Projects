...
def save_object(obj, filename, location="param_grid_pkl"):
    """
...
def load_object(filename, location="param_grid_pkl"):
    """
        ...
        for i, params in enumerate(param_combinations, 1):
            ...
            if params_hash in cache:
                ...
                if "weighted_fbeta" in cached_score["scores"]:
                    ...
                    cached_params = load_object(cached_params_filename, location="param_grid_pkl")
            ...
            save_object(dict(pipeline.steps), cached_params_filename)  # save model and params
            _save_cache(cache)
